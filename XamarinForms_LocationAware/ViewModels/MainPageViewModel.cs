...
namespace XamarinForms_LocationAware.ViewModels
{
    public class MainPageViewModel : BaseViewModel
    {
        ...
        public ICommand CheckInCommand => new Command(async () =>
        {
            ...
            {
                await Application.Current.MainPage.DisplayAlert("Locations", 
                                                                String.Format("You are {0} miles from {1} and have been automatically checked in.", bestMillage.ToString("0.##"), closestLocation.Name ), 
                                                                "OK");
            }
            else
            {
